<template>
	<div style="height: 100%;">
		<el-main :style='"horizontal" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0px 0 0 56px","margin":"0","position":"relative","background":"url(http://codegen.caihongy.cn/20230807/bc751527d2454c82a345e91b17a44608.jpg) no-repeat center top / cover","display":"block"} : {"minHeight":"100%","padding":"0px 0 0 260px","margin":"0","position":"relative","background":"url(http://codegen.caihongy.cn/20230807/bc751527d2454c82a345e91b17a44608.jpg) no-repeat center top / cover","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative","background":"url(http://codegen.caihongy.cn/20230810/535be3394035428fa4bcf636d44a8bf7.gif) no-repeat 80% top,#E8EFF7"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"0 0px 0 0 rgba(0,0,0,.01), 0 0px 0px 0 rgba(0,0,0,.06)","padding":"8px 190px 8px 30px","margin":"0 auto","borderColor":"#f6dce0","alignItems":"center","color":"#333","display":"flex","justifyContent":"space-between","background":"url(http://codegen.caihongy.cn/20230810/535be3394035428fa4bcf636d44a8bf7.gif) no-repeat 20% top / 240px","borderWidth":"0 0 0px","width":"calc(100% - 0px)","fontSize":"18px","position":"relative","borderStyle":"solid","zIndex":"1002","height":"70px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"0px 0 0","margin":"0px auto","borderColor":"#eee","borderWidth":"0 0 0px","background":"none","width":"calc(100% - 60px)","fontSize":"18px","borderStyle":"solid"}' class="bread-crumbs"></bread-crumbs>
