		...
		<el-menu :default-active="activeMenu" :unique-opened="true" :style='{"border":0,"padding":"0 30px","listStyle":"none","margin":"0 auto","flexWrap":"wrap","background":"none","display":"flex","width":"calc(100% - 0px)","position":"relative","transition":"all 0s ease","justifyContent":"center"}' mode="horizontal" class="el-menu-horizontal-2">
		    ...
		    <el-submenu class="user" popper-class="user" :popper-append-to-body="false" :style='{"border":"0","padding":"0","listStyle":"none","margin":"0","color":"#333","order":"10"}' index="1">
				<template slot="title">
					...
					<span :style='{"verticalAlign":"middle","color":"inherit","textAlign":"center","background":"none","display":"inline-block","width":"100%","fontSize":"16px","lineHeight":"0","height":"16px"}' slot="title">个人中心</span>
				</template>
